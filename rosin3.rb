...
#@dispensaries << {:id => "5fd14af4568b4a00c085c55a", :name => "Curaleaf (OR) - Portland", :url => "https://dutchie.com/dispensaries/curaleaf-portland/"} - Removed for - https://www.oregonlive.com/business/2020/02/cura-cannabis-finally-completes-sale-at-sharply-reduced-price-following-layoffs-record-fine-and-fresh-customer-lawsuit.html
